...
<html lang="en">
  ...
  <body>
      ...
      <a class="navbar-brand" href="index.php" style="color : #116b86;"><b>JENJAM BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="index.php" style="color : #116b86;"><b>Home</b></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="createuser.php" style="color : #116b86;"><b>Create User</b></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="transfermoney.php" style="color : #116b86;"><b>Transfer Money</b></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="transactionhistory.php" style="color : #116b86;"><b>Transaction History</b></a>
              </li>
          </div>
       </nav>
  
      <div class="container-fluid">
            <div class="row intro py-1" style="background-color : #75a3a3;">
      ...
      <footer class="text-center mt-5 py-2">
        <p> By <b>Jennifer James</b> <br>&copy 2021</p>
      </footer>
